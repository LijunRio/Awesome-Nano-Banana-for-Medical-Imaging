...
## Example Lists
- [Example 1: Detection of abnormal regions in MRI slice](#example-1)
- [Example 2: Detection of abnormal regions in CT image](#example-2)
- [Example 3: Remove unhealthy areas in MRI (a)](#example-3)
- [Example 4: Remove unhealthy areas in MRI (b)](#example-4)
- [Example 5: Generate healthy version of brain](#example-5)
- [Example 6: Annotate MRI without altering pixels](#example-6)
- [Example 7: Annotate surgical image without altering pixels](#example-7)
- [Example 8: Identify imaging view and anatomical region in MRI](#example-8)
- [Example 9: Remove annotations from MRI scan](#example-9)
- [Example 10: Remove annotations from surgical scan](#example-10)
- [Example 11: Remove skull from MRI image](#example-11)
- [Example 12: Remove skull from MRI image (alternative)](#example-12)
- [Example 13: Generate ultrasound from cardiac MRI](#example-13)
- [Example 14: Generate 3D spine model from sagittal MRI](#example-14)
- [Example 15: Generate abdominal CT from 3D abdomen reconstruction](#example-15)
- [Example 16: Generate 3D mesh of brain](#example-16)
- [Example 17: Generate 3D mesh of teeth](#example-17)
- [Example 18: Simulate tumor progression in brain](#example-18)
- [Example 19: Remove lesion from brain scan](#example-19)
- [Example 20: Remove artifacts from MRI scan (1)](#example-20)
- [Example 21: Remove artifacts from MRI scan (2)](#example-21)
- [Example 22: Segment all visible organs in image](#example-22)
- [Example 23: Segment all visible organs in image (overlay)](#example-23)
- [Example 24: Generate pixel-level segmentation of cardiac chambers](#example-24)
- [Example 25: Generate pixel-level segmentation of brain glioma](#example-25)
- [Example 26: Generate brain segmentation](#example-26)
